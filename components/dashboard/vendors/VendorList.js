                            ...
                            {loading ? (
                                    ...
                                    <tr key={i} style={{ height: ROW_H }}>
                                        ...
                                        <td className="px-4">
                                            <div className="flex justify-end gap-2">
                                                <div className="w-7 h-7 rounded-lg bg-black/6 animate-pulse" />
                                                <div className="w-7 h-7 rounded-lg bg-black/6 animate-pulse" />
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <>
                                        ...
                                        >
                                            ...
                                            <td className="px-4">
                                                <div className="flex items-center gap-2.5 min-w-0">
                                                    <VendorAvatar
                                                        name={vendor.name}
                                                        photo={vendor.logo ?? vendor.avatar ?? vendor.photo}
                                                    />
                                            ...
                                            <td className="px-4 text-[13px] text-[#544b40] truncate">
                                                {vendor.website ? (
                                                    <a
                                                        ...
                                                        className="text-[#C6212F] hover:underline"
                                                    >
                                                        {vendor.website}
                                                    </a>
                                                ) : (
                                            ...
                                            <td
                                                className="px-4 text-[13px] text-[#544b40] truncate"
                                    ...
                                    {vendors.length < PER_PAGE &&
                                        [...Array(PER_PAGE - vendors.length)].map((_, i) => (
