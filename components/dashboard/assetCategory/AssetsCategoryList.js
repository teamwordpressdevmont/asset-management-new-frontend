      ...
      <div className="bg-white rounded-2xl overflow-hidden border border-[#f0ebe3]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm table-fixed">
            <colgroup>
              <col style={{ width: "8%" }} />
              <col style={{ width: isSuperAdmin ? "25%" : "45%" }} />
              {isSuperAdmin && <col style={{ width: "20%" }} />}
              ...
              {loading ? (
                ...
                <>
                    ...
                    >
                      ...
                      <td className="px-4">
                        <div className="flex items-center justify-end gap-1">
                          <Link
                            href={`/assets-category/${cat._id}/edit`}
                  ...
                  {categories.length < PER_PAGE &&
                    [...Array(PER_PAGE - categories.length)].map((_, i) => (
