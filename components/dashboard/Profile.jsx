...
function validate(data) {
  const e = { name: "", email: "", password: "", phone: "" };
...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      ...
      currentUser.profileImage = res.message.data.profileImage;
      ...
      setPreview(`${ASSET_URL}${currentUser.profileImage}`);
      toast.success(res.message?.message || "Profile updated successfully!");
      setLoading(false);
    } else {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      const photo = user.profileImage || user.avatar || user.photo;
