...
export default function EditCompanyForm({ id }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      toast.success(res.message?.message || "Company updated successfully!");
      router.push("/company");
                  ...
                  {fetching ? (
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        clearLogo(); // preview state clear kar do
                      }}
                    />
                  ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                ...
                {fetching ? (
                  ...
                  <>
                    <div
                      className={errors.website ? wrapperError : wrapperNormal}
                    >
                      <span className="text-[#8e8576] grid place-items-center shrink-0">
                        <svg
                          width="15"
