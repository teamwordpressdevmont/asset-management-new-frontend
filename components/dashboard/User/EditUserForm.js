            ...
            <div className="flex flex-col items-center mb-8">
              <div className="relative">
                ...
                >
                  {fetching ? (
                    ...
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <span className="text-[10px] text-[#8e8576] font-medium">
                        Upload
                      </span>
                    </div>
                  )}
                ...
                <button
                  type="button"
                  onClick={
                    preview ? clearPhoto : () => fileRef.current?.click()
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                <label className="block font-semibold mb-1.5 text-[12px] text-[#544b40]">
                  Full Name <span className="text-[#c6212f]">*</span>
                </label>
                {fetching ? (
                  <FieldSkeleton />
                ) : (
              ...
              <div>
                ...
                {fetching ? (
                  ...
                  <>
                    <div
                      className={errors.email ? wrapperError : wrapperNormal}
                    >
                      <span className="text-[#8e8576] grid place-items-center shrink-0">
                        <svg
                          width="15"
              ...
              <div>
                <label className="block font-semibold mb-1.5 text-[12px] text-[#544b40]">
                  New Password{" "}
                  <span className="text-[#8e8576] font-normal">
                    (leave blank to keep)
                  </span>
                </label>
                {fetching ? (
                  ...
                  <>
                    <div
                      className={errors.password ? wrapperError : wrapperNormal}
                    >
                      <span className="text-[#8e8576] grid place-items-center shrink-0">
                        <svg
                          width="15"
                      ...
                      <button
                        ...
                        className="text-[#8e8576] hover:text-[#c6212f] transition-colors shrink-0"
                      >
                        {showPass ? (
                          <svg
                            width="15"
