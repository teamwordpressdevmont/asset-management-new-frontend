        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mt-5">
              ...
              <div>
                <label className="block font-semibold mb-1.5 text-[12px] text-[#544b40]">
                  Password <span className="text-[#c6212f]">*</span>
                </label>
              ...
              <div>
                <label className="block font-semibold mb-1.5 text-[12px] text-[#544b40]">
                  Confirm Password <span className="text-[#c6212f]">*</span>
                </label>
                <div
                  className={
                    errors.confirmPassword ? wrapperError : wrapperNormal
                  }
                >
                  <span className="text-[#8e8576] grid place-items-center shrink-0">
                    <svg
              ...
              {!isAdmin && (
                <div>
                  <label className="block font-semibold mb-1.5 text-[12px] text-[#544b40]">
                    Company <span className="text-[#c6212f]">*</span>
                  </label>
                  <CustomSelect
                    name="company_id"
